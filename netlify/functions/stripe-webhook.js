        ...
        if (userId) {
          ...
          try {
            ...
            if (userDoc.exists) {
              ...
              const formattedBillingDate = nextBillingDate.toLocaleDateString('en-GB', {
                day: 'numeric',
                month: 'long',
                year: 'numeric'
              });
              
              // Send branded upgrade confirmation email
              const siteUrl = process.env.SITE_URL || 'https://aglaea.co.uk';
              ...
              if (emailResult.success) {
                ...
                console.error('Upgrade email failed:', emailResult);
              }
            }
          } catch (emailError) {
            // Don't fail the webhook if email fails
            console.error('Upgrade confirmation email error (non-blocking):', emailError);
          }
        }
        break;
      }
