...
// ============================================================
const SMS_TEMPLATES = {
    14: (name, occasion) => `${name}'s ${occasion} is in 14 days. Find something special: ${SITE_URL.replace('https://', '')}/gifts`,
    7:  (name, occasion) => `${name}'s ${occasion} is just 7 days away. Browse gift ideas: ${SITE_URL.replace('https://', '')}/gifts`,
    3:  (name, occasion) => `Just 3 days left for ${name}'s ${occasion}! Last-minute ideas: ${SITE_URL.replace('https://', '')}/gifts`
};
